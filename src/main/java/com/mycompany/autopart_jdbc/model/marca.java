...
public class marca {
    ...
    public void tipoMarca(String nombre){
    ...
    public void editarMarca(int id, String nombre) throws SQLException {
    ...
    public int eliminarMarca(int id) throws SQLException {
    ...
    public void listaMarca(){
        try {
            ...
            while (rs.next()){
                ...
                System.out.println("id: " + id + " marca:" + nombre);
            }
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
